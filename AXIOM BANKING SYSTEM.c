...
void interest()
{
printf("TERMS AND CONDITION\nREAD ALL SCHEME RELATED DOCUMENTS CAREFULLY\nCOLLATERAL IS REQUIRED FOR LOAN\n MINIMUM 99999 AMOUNT MUST BE THERE IN YOUR ACCOUNT TO TAKE LOAN\n");
printf("4 PERCENT INTEREST WILL BE TAKEN ON AMOUNT LESS THAN 500000\n7 PERCENT INTEREST WILL BE TAKEN ON AMOUNT MORE  THAN 499999\n\n\n\n\n");
  int money,rate;
  float time;
...
{   int choice;
    system("cls");
    system("color 9");
    printf("\n\n\t\t\tWELCOME TO AXIOM BANKING SYSTEM");
    printf("\n\n\n\t\t\t WELCOME TO THE MAIN MENU");
    printf("\n\n\t\t1.Create new account\n\t\t2.For transactions\n\t\t3.View customer's list\n\t\t4.LOAN INTEREST CALCULATION\n\t\t5.Exit\n\n\n\n\n\t\t Enter your choice:");
    scanf("%d",&choice);
...
int main()
{
    char pass[10],password[10]="axiom";
    int i=0;
